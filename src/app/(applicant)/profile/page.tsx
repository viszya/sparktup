			...
			<div className="grid grid-flow-col grid-cols-2 md:grid-cols-1 gap-x-6 m-10 bg-gray-300/10 p-8 rounded-2xl border-2 border-gray-200">
				<div className=" max-w-[30rem]">
					<div className="flex flex-row gap-x-8 mb-4">
						...
						<div>
							<div className="mt-4 text-2xl font-medium tracking-tight text-black sm:text-4xl">Alexander Sandberg</div>
							<div className="mt-2 mb-4 flex flex-row items-center">
								<div className=" text-lg font-medium leading-6 text-black">Software Developer</div>
								<Icons.dot className="h-4 w-4 mx-1 text-gray-500" />
								<div className="text-gray-500">@alexander</div>
							</div>
						</div>
					</div>
					<div className="flex flex-row gap-x-4">
						<div className="w-full flex flex-row justify-center items-center px-3 py-0.5 text-sm border font-medium text-gray-500 duration-200 rounded-sm ">
							<Icons.pin className="h-4 w-4 mr-2" /> Linz, Upper Austria, Austria
						</div>
							...
							<div className="grid items-start grid-cols-1 gap-6 lg:grid-cols-3 lg:gap-24">
								<div className="lg:col-span-2 lg:order-last">
									...
									<ul className="mt-2 text-gray-500 space-y-2">
										<li> - Designed, developed, and owned the administrative tool for Apple's internal systems; Apple Admin Hub</li>
										<li> - Led the development and successful launch of iPadOS support for the Apple News app</li>
										<li> - Spearheaded the development, release, and ongoing management of the Apple News app for iOS devices</li>
										<li> - Collaborated closely with the iOS development team to ensure the implementation of clean and concise code</li>
									</ul>
								</div>
								<div className="justify-center items-center gap-3">
									<div className="flex flex-row gap-x-4 items-center mb-2">
										<img alt="" className="object-cover w-10 h-10 rounded-full lg:h-16 lg:w-16" src="/applelogo.png" />
										<p className="text-lg font-medium leading-6 text-black">
											Apple
										</p>
									</div>
									<div className="flex-1 min-w-0 mb-4">
										<p className="text-sm text-gray-500">
											<span className="text-base text-black">Full-time · Remote</span> <br />
									...
									<Image src="/apple.png" className="rounded-xl shadow-lg" height={100} width={200} alt="apple-banner" />
								</div>
							</div>
						</li>
						<li className="py-4 lg:py-8 border-t">
							<div className="grid items-start grid-cols-1 gap-6 lg:grid-cols-3 lg:gap-24">
								<div className="lg:col-span-2 lg:order-last">
									<p className="text-base text-gray-500">
										Upswing securities passively index inverse bondholders
										capitalization financial health Moody's debt managed. Receive
										bondholders called capitalization investment grade bonds bills
										management district stocks. Potential funds consulting
										expenses.
									</p>
								</div>
								<div className="inline-flex items-center gap-3">
									<div className="flex-shrink-0">
										<img alt="" className="object-cover w-10 h-10 rounded-full lg:h-16 lg:w-16" src="/profile2.png" />
									</div>
					...
					<div className="grid w-full grid-cols-1 mx-auto lg:grid-cols-3">
						<div className="max-w-md p-6 mx-auto">
							<div className="gap-3 lg:inline-flex lg:items-center">
								<div className="flex items-center justify-center w-12 h-12 text-black rounded-xl bg-red-100/70">
									❖
								</div>
							...
							<p className="mt-3 text-base text-gray-500">
								Proficient in iOS development with a focus on creating seamless and engaging mobile experiences for users.
							</p>
						</div>
						<div className="max-w-md p-6 mx-auto">
							<div className="gap-3 lg:inline-flex lg:items-center">
								<div className="flex items-center justify-center w-12 h-12 text-black rounded-xl bg-purple-100/70">
									❖
								</div>
								<p className="mt-4 text-lg font-medium leading-6 text-black lg:mt-0">
									Next.js Development
							...
							<p className="mt-3 text-base text-gray-500">
								Skilled in building robust and scalable web applications using Next.js for efficient server-side rendering.
							</p>
						</div>
						<div className="max-w-md p-6 mx-auto">
							<div className="gap-3 lg:inline-flex lg:items-center">
								<div className="flex items-center justify-center w-12 h-12 text-black rounded-xl bg-teal-100/70">
									❖
								</div>
								<p className="mt-4 text-lg font-medium leading-6 text-black lg:mt-0">
									React Development
							...
							<p className="mt-3 text-base text-gray-500">
								Experienced in building dynamic and interactive user interfaces using React for modern web applications.
							</p>
						</div>
					</div>
				</div>
							...
							<div className="grid items-start grid-cols-1 gap-6 lg:grid-cols-3 lg:gap-24">
								<div className="lg:col-span-2 lg:order-last">
									<p className="text-base text-gray-500">
										...
										processing, and analytics solutions for businesses. With the
										Data Cloud platform, Snowflake manages the complexities of
										data storage infrastructure, enabling organizations to focus
					...
					<div className="relative items-center w-full px-5 py-2 mx-auto md:px-4 lg:px-8 max-w-7xl">
						<div className="grid grid-cols-2 col-span-2 gap-8">
							<div className="p-2 bg-gray-300/10 rounded-2xl border-2 border-gray-200 flex flex-col justify-center items-center">
								<div className="my-4 text-xl ">UI Masterclass</div>
								<Image className="rounded-2xl" src="/dashboard-preview.png" width={400} height={300} alt="project" />
							</div>
							<div className="p-2 bg-gray-300/10 rounded-2xl border-2 border-gray-200 flex flex-col justify-center items-center">
								<div className="my-4 text-xl ">UI Masterclass</div>
								<Image className="rounded-2xl" src="/dashboard-preview.png" width={400} height={300} alt="project" />
