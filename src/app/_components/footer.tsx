                ...
                <div className="flex flex-col items-start justify-between pt-16 pb-6 gap-y-12 lg:flex-row lg:items-center lg:py-16">
                    <div>
                        ...
                        <nav className="flex gap-8 mt-11">
                            <Link className="relative -my-2 -mx-3 rounded-lg px-3 py-2 text-sm text-gray-500 hover:text-teal-300 transition-colors delay-150 hover:delay-0" href="/faq">
                                FAQ
                            </Link>
                            <Link className="relative -my-2 -mx-3 rounded-lg px-3 py-2 text-sm text-gray-500 hover:text-teal-300 transition-colors delay-150 hover:delay-0" href="/about">
                                About
                            </Link>
                            <Link className="relative -my-2 -mx-3 rounded-lg px-3 py-2 text-sm text-gray-500 hover:text-teal-300 transition-colors delay-150 hover:delay-0" href="/tos">
                                Terms
                            </Link>
                            <Link className="relative -my-2 -mx-3 rounded-lg px-3 py-2 text-sm text-gray-500 hover:text-teal-300 transition-colors delay-150 hover:delay-0" href="/privacy">
                                Privacy Policy
                            </Link>
                        </nav>
                    </div>
                    <div className="relative flex items-center self-stretch p-4 -mx-4 transition-colors group hover:bg-gray-200/30 sm:self-auto sm:rounded-2xl lg:mx-0 lg:self-auto lg:p-6">
                        <div className="relative flex items-center justify-center flex-none w-24 h-24 bg-gradient-to-br from-teal-300/30 to-teal-400/50 rounded-xl">
                            <Icons.twitter />
                        </div>
                        <Link href="https://twitter.com/" target="_blank" className="ml-8 lg:w-64">
                            ...
                            <p className="mt-1 text-sm text-gray-500 hover:text-teal-300">
