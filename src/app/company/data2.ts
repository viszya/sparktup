...
export const data2 = [
  ...
  },
  {
    ...
    size: "161,000 employees",
    companyBannerImgSrc: "/apple-park.jpeg",
    foundingYear: "Founded in 1976",
    missionValues: `Apple's mission statement is "to bring the best user experience to its customers through its innovative hardware, software, and services."`,
    missionAndValues: "Bringing the best user experience through innovation in hardware, software, and services",
    about: "Apple Inc. designs, manufactures, and markets smartphones, personal computers, tablets, wearables, and accessories worldwide. The company is known for its innovative products like the iPhone, Mac, iPad, and Apple Watch, along with various MAC software and services.",
    solutionsOverview: "Apple offers a wide range of products and services, including iPhone, iPad, Mac, Apple Watch, Apple TV, as well as IOS applications and digital content through platforms like the App Store, Apple Music, and iCloud.",
    ...
    careerOpportunities: [
      ...
      },
      {
        ...
        "skills": "Software Testing, Machine Learning, +7 more",
        "jobLink": "/",
        "seeSrc": "/",
        "thumbnail": "/apple-banner2.jpeg",
