...
const data = [
  ...
  },
  {
    ...
    about: "Apple Inc. designs, manufactures, and markets smartphones, personal computers, tablets, wearables, and accessories worldwide. The company is known for its innovative products like the iPhone, Mac, iPad, and Apple Watch, along with various software and services.",
    solutionsOverview: "Apple offers a wide range of products and services, including iPhone, iPad, Mac, Apple Watch, Apple TV, as well as software applications and digital content through platforms like the App Store, Apple Music, and iCloud.",
