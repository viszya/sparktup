...
export default function Component() {
  return (
    <div>
      <Card className="w-[730px] bg-white p-6 shadow-lg">
        <CardHeader>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        ...
        <div className="mt-6">
          <h3 className="text-lg font-semibold">Set alert for similar jobs</h3>
          <p className="mt-2 text-sm">Audio Director, Redmond, WA</p>
          <Button className="mt-4" variant="outline">
            Set alert
          </Button>
        </div>
        <div className="mt-6">
          <h3 className="text-lg font-semibold">Pay found in job post</h3>
          <p className="mt-2 text-sm">Retrieved from the description.</p>
          <div className="flex items-center mt-2">
            <p className="text-sm">Is this accurate?</p>
        ...
        <div className="mt-6">
          <h3 className="text-lg font-semibold">How you match</h3>
          ...
          <div className="mt-4">
            ...
            <p className="mt-2 text-sm">Identified by LinkedIn</p>
            <div className="mt-2">
