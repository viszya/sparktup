    ...
    return (
        <div className={cn("applicant-bg")}>
            <div className={cn(twp().wrapper)}>
                ...
                {/* Company Headline */}
                <div className="grid grid-flow-col grid-cols-2 md:grid-cols-1 gap-x-6 m-10 bg-black p-8 rounded-2xl border-2 border-black">
                    <div className=" max-w-[30rem]">
                        ...
                        <div className="flex flex-row gap-x-4">
                            ...
                            <Drawer>
                                <DrawerTrigger className="w-full flex flex-row justify-center items-center px-3 py-0.5 text-sm border font-medium text-white/80 duration-200 rounded-sm hover:text-red-300 hover:border-red-400 hover:scale-95 hover:cursor-pointer">
                                ...
                                <DrawerContent className="flex justify-center items-center">
                                    <DrawerHeader className="max-w-5xl flex justify-center items-center">
                                        <section className="m-10 flex justify-center items-center">
                                            <div className="mt-8 text-xl font-medium tracking-tight text-white sm:text-2xl">Contact Information</div>
                            ...
                            {data.eventData.map((event, index) => (
                                <CarouselItem key={index} className="p-4 md:px-4 lg:px-8 basis-1/2 h-full"> {/* Set a fixed height */}
                                    <div className="bg-black rounded-xl border-2 border-black flex flex-col">
                                        ...
                                        <Link
                                            href={event.viewLink}
                                            className="mt-4 text-sm items-center justify-center w-full px-4 py-2.5 text-center text-white duration-200 bg-black border-2 border-black rounded-lg inline-flex hover:bg-transparent hover:border-black hover:text-white focus:outline-none focus-visible:outline-black"
                                        >
                                            View
                                        </Link>
                                    </div>
                ...
                {/* Team Members */}
                <section className="m-10">
                    <div className="mt-8 text-xl font-medium tracking-tight text-white sm:text-2xl">Team Members</div>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-4">
                ...
                <section className="m-10">
                    <div className="mt-8 text-xl font-medium tracking-tight text-white sm:text-2xl">Career Opportunities</div>
                ...
                {/* Company Culture */}
                <section className="m-10">
                    <div className="mt-8 text-xl font-medium tracking-tight text-white sm:text-2xl">Company Culture</div>
                    <div className="mt-2 text-white/80">{data.companyCulture}</div>
                </section>

                {/* Media Gallery */}
                <section className="m-10">
                    <div className="mt-8 text-xl font-medium tracking-tight text-white sm:text-2xl">Media Gallery</div>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-4">
                ...
                <section className="m-10">
                    <div className="mt-8 text-xl font-medium tracking-tight text-white sm:text-2xl">Legal Information</div>
                ...
                {/* Company Overview */}
                <section className="m-10">
                    <div className="mt-8 text-xl font-medium tracking-tight text-white sm:text-2xl">Overview</div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-4">
                ...
                <section className="m-10">
                    <div className="mt-8 text-xl font-medium tracking-tight text-white sm:text-2xl">Commitments</div>
