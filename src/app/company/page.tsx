  ...
  return (
    <div className="applicant-bg">
      <div className={cn(twp().wrapper)}>
        <h2 className="sm:mt-30 mb-11 mt-20 text-center text-4xl font-semibold">
          Companies
        </h2>

        {/* Company Headline */}
        {data?.map((data: any) => (
          <div className="m-10 grid grid-flow-col grid-cols-2 gap-x-6 rounded-2xl border-2 border-white bg-white p-8 md:grid-cols-1">
            <div className=" max-w-[30rem]">
              ...
              <div className="flex flex-row gap-x-4">
                ...
                <Drawer>
                  <DrawerTrigger className="flex w-full flex-row items-center justify-center rounded-sm border px-3 py-0.5 text-sm font-medium text-gray-500 duration-200 hover:scale-95 hover:cursor-pointer hover:border-red-400 hover:text-red-300">
