      ...
      <div className={twp().wrapper}>
        <div className="mx-4 my-8 mb-20 text-black md:mx-20">
          <article>
            ...
            <div className="mt-4 rounded-xl border-2 border-white/80 bg-white p-4 text-base text-black md:mt-6 md:text-lg ">
              Welcome to Sparktup, where innovation meets opportunity. Founded
              by Vedant Lad, Vishwa Anand, and Akshay Burra, Sparktup was born
          ...
          <article>
            ...
            <div className="mt-4 rounded-xl border-2 border-white/80 bg-white p-4 text-base text-black/80 md:mt-6 md:text-lg">
              <div>
                <span className="text-lg tracking-tighter text-black md:text-xl">
                  Our Mission:
                </span>{" "}
                <br />
              ...
              <div className="mt-4">
                ...
                <ul className="space-y-2">
                  <li>
                    <span className="text-base tracking-tighter text-black md:text-lg">
                      &nbsp; - &nbsp;Empowerment:
                    </span>{" "}
