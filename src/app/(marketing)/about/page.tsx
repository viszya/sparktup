  ...
  return (
    <div className={cn(twp().wrapper, "mt-4")}>
      <div className="mx-4 md:mx-20">
        <article>
          <div className="text-center mt-6 md:mt-10 text-4xl tracking-tighter text-blaprimaryck">
            About Sparktup
          </div>
        ...
        <article>
          <div className="text-center mt-6 text-3xl tracking-tighter text-primary">
            Mission and Goals
          </div>
