      ...
      <div className="mx-20">
        <article>
          ...
          <div className="mt-4 text-gray-500 text-lg">
            <p>
              <span className="text-lg tracking-tighter text-black">1. Acceptance of Terms:</span>
              <br />
        ...
        <article>
          ...
          <div className="mt-4 text-gray-500 text-lg">
            <p>
              <span className="text-lg tracking-tighter text-black">a. Account Creation:</span>
              <br />
              Users are required to create an account to access certain features
              of Sparktup.
            </p>
            <p>
              <span className="text-lg tracking-tighter text-black">b. Account Information:</span>
              <br />
              You are responsible for providing accurate and updated information
              during account creation.
            </p>
            <p>
              <span className="text-lg tracking-tighter text-black">c. Account Security:</span>
              <br />
        ...
        <article>
          ...
          <div className="mt-4 text-gray-500 text-lg">
            <p>
              <span className="text-lg tracking-tighter text-black">a. Lawful Use:</span>
              <br />
        ...
        <article>
          ...
          <div className="mt-4 text-gray-500 text-lg">
            <p>
              <span className="text-lg tracking-tighter text-black">Our Privacy Policy governs the collection, use, and disclosure of user information. By using Sparktup, you consent to our privacy practices outlined in the Privacy Policy.</span>
            </p>
          </div>
        </article>
        ...
        <article>
          ...
          <div className="mt-4 text-gray-500 text-lg">
            <p>
              <span className="text-lg tracking-tighter text-black">a. Ownership:</span>
              <br />
              Sparktup retains ownership of all intellectual property associated with the platform.
            </p>
            <p>
              <span className="text-lg tracking-tighter text-black">b. User Content:</span>
              <br />
