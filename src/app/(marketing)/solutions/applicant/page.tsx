...
export default function ApplicantSolutions() {
  return (
    <div className={cn("flex flex-col justify-center items-center", twp().wrapper)}>
      ...
      {/* Hero */}
      <section className="text-center py-16 bg-white/80">
      ...
      {/* Key Benefits */}
      <section className="text-center py-8 px-10 mb-10">
        <h1 className="text-4xl font-bold text-black mb-8">Key Benefits</h1>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Benefit 1 */}
          <div className="p-6 rounded-xl flex flex-col justify-center items-center border-2 border-green-400 bg-green-100/30 bg-white/80">
          ...
          {/* Benefit 2 */}
          <div className="p-6 rounded-xl flex flex-col justify-center items-center bg-blue-100/10 border-blue-400 border-2 bg-white/80">
          ...
          {/* Benefit 3 */}
          <div className="p-6 rounded-xl flex flex-col justify-center items-center border-2 border-purple-400 bg-purple-100/10 bg-white/80">
      ...
      <section className="text-center py-8 px-10 overflow-hidden">
        <h1 className="text-4xl font-bold text-black mb-8">How Sparktup Works for Applicants</h1>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* Step 1 */}
          <div className="p-6 border-teal-400 border-2 rounded-xl flex flex-col justify-center items-center bg-white/80">
      ...
      <section className="text-center py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Feature 1 */}
          <div className="p-6 border-green-400 border-2 rounded-xl flex flex-col justify-center items-center bg-white/80">
