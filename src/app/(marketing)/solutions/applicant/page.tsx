...
export default function ApplicantSolutions() {
	return (
		<div className={cn("flex flex-col justify-center items-center", twp().wrapper)}>
			...
			{/* Key Benefits */}
			<section className="text-center py-8 px-10 bg-gray-100/10 border-gray-200 border-2 rounded-xl mb-10">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mr-3 ml-3">
					{/* Benefit 1 */}
					<div className="p-6 rounded-xl  flex flex-col justify-center items-center border-2 border-green-400 bg-green-100/30">
					...
					{/* Benefit 2 */}
					<div className="p-6 rounded-xl  flex flex-col justify-center items-center bg-blue-100/10 border-blue-400 border-2">
					...
					{/* Benefit 3 */}
					<div className="p-6 border-2 rounded-xl  flex flex-col justify-center items-center bg-purple-100/10 border-purple-400">
			...
			<section className="text-center py-8 px-10 bg-gray-100/10 rounded-xl overflow-hidden border-gray-200 border-2">
				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-8 ml-3 mr-3">
					{/* Step 1 */}
					<div className="p-6 bg-teal-100/10 border-2 border-teal-400 rounded-xl  flex flex-col justify-center items-center">
						<Icons.UserPlus className="h-8 w-8 text-teal-400 mb-4" />
					...
					{/* Step 2 */}
					<div className="p-6 bg-teal-100/10 border-2 border-teal-400 rounded-xl  flex flex-col justify-center items-center">
						<Icons.search className="h-8 w-8 text-teal-400 mb-4" />
					...
					{/* Step 3 */}
					<div className="p-6 bg-teal-100/10 border-2 border-teal-400 rounded-xl  flex flex-col justify-center items-center">
						<Icons.Mail className="h-8 w-8 text-teal-400 mb-4" />
					...
					{/* Step 4 */}
					<div className="p-6 bg-teal-100/10 border-2 border-teal-400 rounded-xl  flex flex-col justify-center items-center">
						<Icons.Chat className="h-8 w-8 text-teal-400 mb-4" />
			...
			<section className="text-center py-16">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
					{/* Feature 1 */}
					<div className="p-6 bg-green-100/10 border-2 border-green-400 rounded-xl  flex flex-col justify-center items-center">
