...
export default function Page() {
  return (
    <div className={cn("landing-bg flex flex-col items-center justify-center")}>
      <div
        className={cn(
          twp().wrapper,
        ...
        >
          ...
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              ...
              please reach out to our partnership team through the &quot;Contact
              Us&quot; section on the website. We&apos;ll guide you through the
              process and discuss how we can tailor our services to meet your
          ...
          <AccordionItem value="item-2">
            ...
            <AccordionContent>
              ...
              skilled professionals based on specific filters and requirements.
              Our advanced matching algorithms and extensive network of
              individuals allow us to tailor our search to match your
          ...
          <AccordionItem value="item-3">
            ...
            <AccordionContent>
              ...
              companies, apply to positions, and showcase their skills on their
              profiles. It&apos;s a platform where professionals can connect
              with companies, making the job search and application process more
              efficient.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-4">
            <AccordionTrigger className="text-left">
              How does Sparktup ensure the quality of candidates for my company?
            </AccordionTrigger>
            <AccordionContent>
              Sparktup employs a rigorous screening process to ensure the
              quality of candidates. We assess skills, experience, and
              compatibility with your company&apos;s requirements, providing you
              with candidates that match your expectations.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-5">
            ...
            <AccordionContent>
              ...
              Job&quot; section, and filling out the necessary details. Reach a
              wider pool of candidates through our platform.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-7">
            ...
            <AccordionContent>
              ...
              &quot;Contact Us&quot; section for detailed information on pricing
              and available plans.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-8">
            ...
            <AccordionContent>
              Individuals can highlight their skills by updating their profiles
              with relevant information, including work experience, projects,
              and technical expertise. This information helps them stand out to
              potential employers browsing the platform.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-10">
            ...
            <AccordionContent>
              Sparktup caters to a broad range of tech industries, including but
              not limited to software development, cybersecurity, data science,
              and IT infrastructure. Our diverse network allows us to address
              the hiring needs of companies across various tech sectors.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-11">
            ...
            <AccordionContent>
              ...
              their accounts to receive updates on job opportunities that match
              their skills, experience, and preferences.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-12">
            ...
            <AccordionContent>
              ...
              policy outlines how data is collected, used, and stored securely.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-13">
            ...
            <AccordionContent>
              ...
              support team is available to guide you through the hiring process
          ...
          <AccordionItem value="item-16">
            ...
            <AccordionContent>
              ...
              allows for informed decision-making and ensures compatibility with
