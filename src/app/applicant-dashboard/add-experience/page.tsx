...
export default function AddCareer() {
    ...
    return (
        <div className="flex flex-col px-8">
            <div>
                <h2 className="text-3xl font-bold tracking-tight">Add Experience to Your Profile</h2>
                <p className="text-muted-foreground">
                    Go through the form processes to add experience to your profile
                </p>
            </div>
            <div className="flex flex-col justify-center w-full ">
                <Tabs value={activeTab} className="mt-5">
                    <TabsList className="flex flex-row gap-x-6 overflow-x-auto">
                        <TabsTrigger value="form1">Add Experience</TabsTrigger>
                        <Icons.chevronRight className="text-gray-300 h-5 w-5" />
                        <TabsTrigger value="form2">Experience Info</TabsTrigger>
                    </TabsList>
